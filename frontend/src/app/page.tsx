...
const REVIEWS = [
  "Мега крутой сайт для обучения Python, с помощью него я стал лучшим на планете программистом. Спасибо разрабам.",
  "Мега крутой сайт для обучения Python, с помощью него я стал лучшим на планете программистом. Спасибо разрабам.",
  "Мега крутой сайт для обучения Python, с помощью него я стал лучшим на планете программистом. Спасибо разрабам.",
  "Мега крутой сайт для обучения Python, с помощью него я стал лучшим на планете программистом. Спасибо разрабам.",
  "Мега крутой сайт для обучения Python, с помощью него я стал лучшим на планете программистом. Спасибо разрабам.",
    ...
    <section className="px-4 sm:px-6 lg:px-16 pt-10 sm:pt-14 lg:pt-20 pb-12 sm:pb-16 lg:pb-24">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        ...
        <div>
          ...
          <Btn href="/register" fullWidthMobile>Начать бесплатно</Btn>
        </div>
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="flex justify-center mt-10 sm:mt-12">
          <Btn href="/register">Начать бесплатно</Btn>
        </div>
      </div>
    </section>
  );
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
        ...
        {/* Кнопка справа */}
        <Btn href="/register" className="w-full lg:w-auto shrink-0">Начать бесплатно</Btn>
      </div>
    </section>
  );
}
